 ...
 */
export const agentCreateTodoStream = <ThrowOnError extends boolean = false>(options: Options<AgentCreateTodoStreamData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<AgentCreateTodoStreamResponses, AgentCreateTodoStreamErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
